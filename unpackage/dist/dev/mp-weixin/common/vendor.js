...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__AAEC9A3" };exports.default = _default;
...
/**
    * 不跳转自动登录
    */
var postNoAutoLogin = function postNoAutoLogin(request, interfaceName, hideLoading) {
  return new Promise(function (resolve, inject) {
    _commonFunction.default.checkStorgeHasUser(false).then(function (token) {
      realPost(request, interfaceName, token, hideLoading).then(function (res) {
        resolve(res);
...
/**
    * 跳转自动登录form-data请求
    */
var postParams = function postParams(request, interfaceName, hideLoading) {
  return new Promise(function (resolve, inject) {
    _commonFunction.default.checkStorgeHasUser(true).then(function (token) {
      realPostParams(request, interfaceName, token, hideLoading).then(function (res) {
        resolve(res);
      }).catch(function (reason) {inject(reason);});
    }).catch(function () {inject('尚未登录!');});
  });
...
var forAllCard = 'forAllCard';
var choosedBrand = 'choosedBrand';
var choosedCustomer = 'choosedCustomer';
var memoText = 'memoText';
var customerInfo = 'customerInfo';
var verifyCoupon = 'verifyCoupon';
var showReceivable = 'showReceivable';
var rule = 'rule';
var couponDetail = 'couponDetail';var _default =
{
  ...
  rule: rule,
  couponDetail: couponDetail };exports.default = _default;
